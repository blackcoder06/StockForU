...
<br />Now, we are breaking ground with our technology.</h1>
        ...
        <div className='col-12 col-md-6 p-5'>
            <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company StockForU, a combination of Stock and "It's for U", you can grow with StockForU.</p>
