...
function ProductPage() {
    return (
        ...
        <RightSection imageURL="media/images/console.png" productName="Console" productDescription="The central dashboard for your StockForU account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore="" />
        ...
        <p className='text-center fs-5 m-5'>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>StockForU.tech blog.</a>StockForU.tech blog.</p>
        <Universe/>
